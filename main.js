...
function repeatChar(string, times) {
 while(times <= 0) 
    return "";
    return string + repeatChar(string, times - 1);
}
console.log(repeatChar("a", 2));
console.log(repeatChar("c".toUpperCase(), 5));
...
/* Q4:
Using recursion 
Create a function called stringToCapital in javascript
that takes a string 
